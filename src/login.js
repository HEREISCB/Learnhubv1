...
const Flogin = ({ navigation }) => {
  ...
  const [creatingusername, puttingusername] = useState(false);
  ...
  return (<>
    ...
    <SignedOut>
      ...
      <SafeAreaView style={customstyles.container}>
        <Image
          style={{ width: 400, height: 250, marginTop: -70, marginBottom: 20 }}
          source={{
            uri: "https://sgipolytechnic.in/static/media/Dblock.03234074.jpg",
          }}
        />
        <Text
          style={{
        ...
        <View style={{ padding: 5, paddingBottom: 10 }}></View>

        <Pressable
          style={customstyles.cusbut}
          onPress={() => {
            pascheck();
          }}
        >
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Image
                  ...
                  source={require("../assets/cat1.gif")}
                />
